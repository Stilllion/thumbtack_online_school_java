...
public class Triangle extends Figure
{
	...
	public Triangle(Point2D point1, Point2D point2, Point2D point3, String stringColor) throws ColorException
	{
		this(point1, point2, point3, Color.colorFromString(stringColor));
	}
	...
	public boolean isInside(int x, int y) throws ColorException
	{
		Triangle t1 = new Triangle(this.point1, this.point2, new Point2D(x, y), color);
		Triangle t2 = new Triangle(new Point2D(x, y), this.point2, this.point3, color);
		Triangle t3 = new Triangle(this.point1, new Point2D(x, y), this.point3, color);
