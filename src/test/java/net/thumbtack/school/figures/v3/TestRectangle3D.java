...
public class TestRectangle3D {
    ...
    public void testSetTopLeft() throws ColorException{
        Rectangle3D rect3d = new Rectangle3D("RED");
        Point3D newTopLeft = new Point3D(42, 42, 42);
        rect3d.setTopLeft(newTopLeft);
        assertEquals(newTopLeft, rect3d.getTopLeft());
    }

    @Test
    public void testSetBottomRight() throws ColorException{
        Rectangle3D rect3d = new Rectangle3D("RED");
        Point3D newBottomRight = new Point3D(42, 42, 42);
        rect3d.setBottomRight(newBottomRight);
        assertEquals(newBottomRight, rect3d.getBottomRight());
    }
    ...
    public void testSetHeight() throws ColorException{
        Rectangle3D rect3d = new Rectangle3D("RED");
        rect3d.setHeight(42);
        assertEquals(42, rect3d.getHeight());
    }
