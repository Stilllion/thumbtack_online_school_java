...
public class TestRectangle {
    ...
    public void testSetTopLeft() throws ColorException{
        ...
        Point2D newTopLeft = new Point2D(42, 42);
        rect.setTopLeft(newTopLeft);
        assertEquals(newTopLeft, rect.getTopLeft());
    }

    @Test
    public void testSetBottomRight() throws ColorException{
        Rectangle rect = new Rectangle(10, 20, "RED");
        Point2D newBottomRight = new Point2D(42, 42);
        rect.setBottomRight(newBottomRight);
        assertEquals(newBottomRight, rect.getBottomRight());
    }
