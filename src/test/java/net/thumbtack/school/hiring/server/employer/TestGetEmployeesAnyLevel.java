...
public class TestGetEmployeesAnyLevel
{
    Server s = new Server();
    Gson gson = new Gson();
    ...
    @Test
    public void testGetEmployeesAnyLevel()
    {
        ...
        // Register 5 employees with different skills, only the 1st  and the 5th would be applicable
